...
/* Deterministic input generator for projection diagnostics. */
...
int main(int argc, char **argv)
{
    ...
    if (!strcmp(argv[2], "genp") && argc >= 5) {
        /* genp <tools.json> <query> [max_new] - generation diagnostics.
         * This host utility does not execute the firmware tool handlers. */
        nd_model  m;
        char     *tools;
        size_t    tools_len;
        char     *prompt;
